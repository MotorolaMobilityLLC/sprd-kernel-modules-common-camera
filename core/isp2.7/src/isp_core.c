...
static int isp_afbc_store(struct isp_path_desc *path)
{
	...
	pad_width = (afbc_store_info->size.w + AFBC_PADDING_W_YUV420_scaler - 1)
		/ AFBC_PADDING_W_YUV420_scaler * AFBC_PADDING_W_YUV420_scaler;
	pad_height = (afbc_store_info->size.h + AFBC_PADDING_H_YUV420_scaler - 1)
		/ AFBC_PADDING_H_YUV420_scaler * AFBC_PADDING_H_YUV420_scaler;

	w_tile_num = pad_width / AFBC_PADDING_W_YUV420_scaler;
	h_tile_num = pad_height / AFBC_PADDING_H_YUV420_scaler;
...
{
	int ret = 0;
	int i, loop, kick_fmcu = 0, slc_by_ap = 0;
