...
static inline uint32_t cal_sprd_raw_pitch(uint32_t w)
{
	...
	uint32_t mod64_len[64] = {0, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,//12
								32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32,//24
								48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48,//36
								64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64,//48
								80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80};//63

	return((w / 64) * 80 + (mod64_len[w % 64]));
}
#endif /* _CAM_TYPES_H_ */
