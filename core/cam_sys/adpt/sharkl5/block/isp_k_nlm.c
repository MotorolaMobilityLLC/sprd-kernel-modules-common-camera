...
int isp_k_cpy_nlm(struct dcam_isp_k_block *param_block, struct dcam_isp_k_block *isp_k_param)
{
	...
	if (isp_k_param->imbalance_info_v0_base.isupdate == 1) {
		memcpy(&param_block->imbalance_info_v0_base, &isp_k_param->imbalance_info_v0_base, sizeof(struct isp_dev_nlm_imblance));
		isp_k_param->imbalance_info_v0_base.isupdate = 0;
		param_block->imbalance_info_v0_base.isupdate = 1;
	}
