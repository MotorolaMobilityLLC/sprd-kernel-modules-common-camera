...
static const struct bypass_tag dcam_bypass_tab[] = {
	...
	[_E_BLC]     = {"blc",       DCAM_BLC_PARA,               0}, /* 0x268.b31 */
...
static uint32_t ISP_CFG_MAP[] __aligned(8) = {
		...
		0x03F1D8F0, /*0x1D8F0 - 0x1DCEC, 255 , ISP_CAP_PATH_VER_CORF_Y_BUF0_CH0*/
		0x03F1F000, /*0x1F000 - 0x1F3FC, 255 , ISP_CAP_PATH_VER_CORF_UV_BUF0_CH0*/
		0x03F20400, /*0x20400 - 0x207FC, 255 , ISP_VID_PATH_HOR_CORF_Y_BUF0_CH0*/
		0x03F20C00, /*0x20C00 - 0x20FFC, 255 , ISP_VID_PATH_HOR_CORF_UV_BUF0_CH0*/
		0x03F21400, /*0x21400 - 0x217FC, 255 , ISP_VID_PATH_VER_CORF_Y_BUF0_CH0*/
		0x03F21C00, /*0x21C00 - 0x21FFC, 255 , ISP_VID_PATH_VER_CORF_UV_BUF0_CH0*/
			...
			struct isp_regular_info *regular_info)
{
	...
	ISP_REG_MWR(idx, addr, (BIT_25 | BIT_26), regular_info->regular_mode << 25);
...
static int isphw_fetch_set(void *handle, void *arg)
{
	...
	ISP_REG_MWR(idx, ISP_FETCH_BASE + ISP_FETCH_MIPI_PARAM, BIT_20, is_pack<< 20);
	...
	if (fetch->sec_mode == SEC_SPACE_PRIORITY) {
		cam_trusty_isp_pitch_set(fetch->pitch.pitch_ch0,
			fetch->pitch.pitch_ch1, fetch->pitch.pitch_ch2);
	} else {
...
static int isphw_fetch_fbd_set(void *handle, void *arg)
{
	...
	if (fbd_yuv->data_bits == CAM_8_BITS)
		fbd_yuv->afbc_mode = AFBD_FETCH_8BITS;
	else if (fbd_yuv->data_bits == CAM_10_BITS)
