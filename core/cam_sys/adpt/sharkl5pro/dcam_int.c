...
static const dcam_int_isr _DCAM_ISR_IRQ[DCAM_HW_CONTEXT_MAX][32] = {
	...
	[0][DCAM_LSCM_TX_DONE] = dcam_int_common_lscm_port_done,
	[0][DCAM_GTM_TX_DONE] = dcam_int_common_gtm_port_done,

	[1][DCAM_SENSOR_SOF] = dcamint_irq_sensor_sof,
	...
	[1][DCAM_LSCM_TX_DONE] = dcam_int_common_lscm_port_done,
	[1][DCAM_GTM_TX_DONE] = dcam_int_common_gtm_port_done,

	[2][DCAM_SENSOR_SOF] = dcamint_irq_sensor_sof,
	[2][DCAM_SENSOR_EOF] = dcam_int_common_irq_sensor_eof,
	[2][DCAM_CAP_SOF] = dcamint_irq_cap_sof,
	[2][DCAM_PREVIEW_SOF] = dcam_int_common_irq_preview_sof,
	[2][DCAM_FULL_PATH_TX_DONE] = dcam_int_common_full_port_done,
	[2][DCAM_PREV_PATH_TX_DONE] = dcam_int_common_bin_port_done,
	[2][DCAM_PDAF_PATH_TX_DONE] = dcam_int_common_pdaf_port_done,
	[2][DCAM_VCH2_PATH_TX_DONE] = dcam_int_common_vch2_port_done,
	[2][DCAM_VCH3_PATH_TX_DONE] = dcam_int_common_vch3_port_done,
	[2][DCAM_AEM_TX_DONE] = dcam_int_common_aem_port_done,
	[2][DCAM_HIST_TX_DONE] = dcam_int_common_hist_port_done,
	[2][DCAM_AFL_TX_DONE] = dcam_int_common_afl_port_done,
	[2][DCAM_AFM_INTREQ1] = dcam_int_common_afm_port_done,
	[2][DCAM_NR3_TX_DONE] = dcam_int_common_nr3_port_done,
	[2][DCAM_LSCM_TX_DONE] = dcam_int_common_lscm_port_done,
	[2][DCAM_GTM_TX_DONE] = dcam_int_common_gtm_port_done,
};
