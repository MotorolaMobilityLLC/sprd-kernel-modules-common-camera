...
static int camscaler_sin_core(int arc_q33, int sign)
{
 ...
 {
 	signed char mount = 0;
 	short i = 0, mid_i = 0, kk = 0, j = 0, sum_val = 0;
 	short *normal_filter = NULL;
 	int value_x = 0, value_y = 0, angle_32 = 0;
 	int64_t *filter = NULL;
 	int64_t *tmp_filter = NULL;
 	int64_t dividend = 0, divisor = 0;
 	int64_t angle_x = 0, angle_y = 0;
 	int64_t a = 0, b = 0, t = 0;
 	...
 	short *y_coef_ptr, short *uv_coef_ptr)
 {
 	...
 	int k = 0;
 	unsigned int val = 0;
 	short y_coef_arr[32][8] = {0};
	short uv_coef_arr[32][8] = {0};
...
unsigned char cam_scaler_isp_scale_coeff_gen_ex(short i_w, short i_h,
 ...
 //	short i_hor = o_w;
 	...
 	unsigned short luma_ver_tap = 0, chroma_ver_tap = 0;
