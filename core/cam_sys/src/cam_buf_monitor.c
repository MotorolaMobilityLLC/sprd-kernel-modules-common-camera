...
void cam_buf_monitor_memory_queue_deinit(void)
{
	...
	cam_queue_clear(g_mem_dbg->memory_alloc_queue, struct cam_buf_alloc_info, list);
	g_mem_dbg->memory_alloc_queue = NULL;
	cam_queue_clear(g_mem_dbg->empty_memory_alloc_queue, struct cam_buf_alloc_info, list);
