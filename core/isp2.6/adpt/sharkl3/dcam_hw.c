...
static int sharkl3_dcam_clk_eb(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_clk_dis(void *handle, void *arg)
{
	int ret = 0;
	struct cam_hw_info *hw = NULL;
	struct cam_hw_soc_info *soc = NULL;
...
static int sharkl3_dcam_axi_init(void *handle, void *arg)
{
	uint32_t time_out = 0;
	uint32_t idx = 0;
	struct cam_hw_info *hw = NULL;
	...
	hw->dcam_ioctl(hw, DCAM_AXIM_AQOS_MASK, NULL);
...
static int sharkl3_dcam_qos_set(void *handle, void *arg)
{
	uint32_t reg_val = 0;
	struct cam_hw_info *hw = NULL;
	struct cam_hw_soc_info *soc = NULL;
...
static int sharkl3_dcam_start(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_stop(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_cap_disable(void *handle, void *arg)
{
	int ret = 0;
	uint32_t idx = 0;
...
static int sharkl3_dcam_auto_copy(void *handle, void *arg)
{
...
static int sharkl3_dcam_force_copy(void *handle, void *arg)
{
...
static int sharkl3_dcam_reset(void *handle, void *arg)
{
	int ret = 0;
	int i = 0;
	enum dcam_id idx = 0;
...
static int sharkl3_dcam_fetch_set(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_slice_fetch_set(void *handle, void *arg)
{
	int ret = 0;
	uint32_t fetch_pitch;
...
static int sharkl3_dcam_fetch_block_set(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_mipi_cap_set(void *handle, void *arg)
{
	int ret = 0;
	uint32_t idx = 0;
	uint32_t reg_val;
...
static int sharkl3_dcam_path_start(void *handle, void *arg)
{
	int ret = 0;
	uint32_t value;
...
static int sharkl3_dcam_path_stop(void *handle, void *arg)
{
	int ret = 0;
	uint32_t reg_val;
	uint32_t idx;
...
static int sharkl3_dcam_path_ctrl(void *handle, void *arg)
{
...
static int sharkl3_dcam_fetch_start(void *handle, void *arg)
{
...
static int sharkl3_dcam_full_path_src_sel(void *handle, void *arg)
{
	int ret = 0;
...
static int sharkl3_dcam_ebd_set(void *handle, void *arg)
{
...
static int sharkl3_dcam_binning_4in1_set(void *handle, void *arg)
{
...
static int sharkl3_dcam_sram_ctrl_set(void *handle, void *arg)
{
...
static int sharkl3_dcam_block_func_get(void *handle, void *arg)
{
...
static int sharkl3_dcam_cfg_mipicap(void *handle, void *arg)
{
...
static int sharkl3_dcam_start_fetch(void *handle, void *arg)
{
	DCAM_AXIM_WR(IMG_FETCH_START, 1);
...
static int sharkl3_dcam_bin_mipi_cfg(void *handle, void *arg)
{
	uint32_t reg_val = 0;
...
static int sharkl3_dcam_cfg_bin_path(void *handle, void *arg)
{
...
static struct hw_io_ctrl_fun sharkl3_dcam_ioctl_fun_tab[] = {
	{DCAM_HW_CFG_ENABLE_CLK,            sharkl3_dcam_clk_eb},
	{DCAM_HW_CFG_DISABLE_CLK,           sharkl3_dcam_clk_dis},
	{DCAM_HW_CFG_INIT_AXI,              sharkl3_dcam_axi_init},
	{DCAM_HW_CFG_SET_QOS,               sharkl3_dcam_qos_set},
	{DCAM_HW_CFG_RESET,                 sharkl3_dcam_reset},
	{DCAM_HW_CFG_START,                 sharkl3_dcam_start},
	{DCAM_HW_CFG_STOP,                  sharkl3_dcam_stop},
	{DCAM_HW_CFG_STOP_CAP_EB,           sharkl3_dcam_cap_disable},
	{DCAM_HW_CFG_FETCH_START,           sharkl3_dcam_fetch_start},
	{DCAM_HW_CFG_AUTO_COPY,             sharkl3_dcam_auto_copy},
	{DCAM_HW_CFG_FORCE_COPY,            sharkl3_dcam_force_copy},
	{DCAM_HW_CFG_PATH_START,            sharkl3_dcam_path_start},
	{DCAM_HW_CFG_PATH_STOP,             sharkl3_dcam_path_stop},
	{DCAM_HW_CFG_PATH_CTRL,             sharkl3_dcam_path_ctrl},
	{DCAM_HW_CFG_PATH_SRC_SEL,          sharkl3_dcam_full_path_src_sel},
	{DCAM_HW_CFG_PATH_SIZE_UPDATE,      sharkl3_dcam_path_size_update},
	{DCAM_HW_CFG_MIPI_CAP_SET,          sharkl3_dcam_mipi_cap_set},
	{DCAM_HW_CFG_FETCH_SET,             sharkl3_dcam_fetch_set},
	{DCAM_HW_CFG_FETCH_BLOCK_SET,       sharkl3_dcam_fetch_block_set},
	{DCAM_HW_CFG_EBD_SET,               sharkl3_dcam_ebd_set},
	{DCAM_HW_CFG_BINNING_4IN1_SET,      sharkl3_dcam_binning_4in1_set},
	{DCAM_HW_CFG_SRAM_CTRL_SET,         sharkl3_dcam_sram_ctrl_set},
	{DCAM_HW_CFG_SLICE_FETCH_SET,       sharkl3_dcam_slice_fetch_set},
	{DCAM_HW_CFG_BLOCK_FUNC_GET,        sharkl3_dcam_block_func_get},
	{DCAM_HW_CFG_MIPICAP,               sharkl3_dcam_cfg_mipicap},
	{DCAM_HW_CFG_START_FETCH,           sharkl3_dcam_start_fetch},
	{DCAM_HW_CFG_BIN_MIPI,              sharkl3_dcam_bin_mipi_cfg},
	{DCAM_HW_CFG_BIN_PATH,              sharkl3_dcam_cfg_bin_path},
};

static hw_ioctl_fun sharkl3_dcam_ioctl_get_fun(
	enum dcam_hw_cfg_cmd cmd)
{
	...
	total_num = sizeof(sharkl3_dcam_ioctl_fun_tab) / sizeof(struct hw_io_ctrl_fun);
	for (i = 0; i < total_num; i++) {
		if (cmd == sharkl3_dcam_ioctl_fun_tab[i].cmd) {
			hw_ctrl = sharkl3_dcam_ioctl_fun_tab[i].hw_ctrl;
			break;
		}
	}
