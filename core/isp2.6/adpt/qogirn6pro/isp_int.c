...
static void ispint_iommu_regs_dump(void)
{
	...
	pr_err("store pre cap y %08x u %08x afbc head y %08x y %08x offset %08x\n",
		...
		ISP_HREG_RD(ISP_STORE_PRE_CAP_BASE + ISP_FBC_STORE_SLICE_HEADER_BASE_ADDR),
		ISP_HREG_RD(ISP_STORE_PRE_CAP_BASE + ISP_FBC_STORE_SLICE_PAYLOAD_BASE_ADDR),
		ISP_HREG_RD(ISP_STORE_PRE_CAP_BASE +ISP_FBC_STORE_SLICE_PAYLOAD_OFFSET_ADDR));
	...
	pr_err("store vid y %08x u %08x fbc head y %08x y %08x offset %08x\n",
		...
		ISP_HREG_RD(ISP_STORE_VID_BASE  + ISP_FBC_STORE_SLICE_HEADER_BASE_ADDR),
		ISP_HREG_RD(ISP_STORE_VID_BASE  + ISP_FBC_STORE_SLICE_PAYLOAD_BASE_ADDR),
		ISP_HREG_RD(ISP_STORE_VID_BASE  + ISP_FBC_STORE_SLICE_PAYLOAD_OFFSET_ADDR));
