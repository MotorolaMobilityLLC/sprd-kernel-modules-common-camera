...
static const struct bypass_tag dcam_bypass_tab[] = {
	...
	[_E_BLC]  = {"blc",  DCAM_BLC_PARA_R_B,           0}, /* 0x268.b0 */
...
isp_hw_para:
	...
	ISP_HREG_MWR(ISP_ARBITER_RD_PARAM2, 0xFFFFFFFF, 0x0010FF10);
	ISP_HREG_MWR(ISP_ARBITER_RD_PARAM4, 0xFFFFFFFF, 0x0F100010);
	ISP_HREG_MWR(ISP_ARBITER_RD_PARAM5, 0xFFFFFFFF, 0xFF100F10);
	...
	ISP_HREG_MWR(PYR_DEC_FETCH_BASE + ISP_FETCH_PARAM1, 0xFFFFFFFF, 0x00007070);
