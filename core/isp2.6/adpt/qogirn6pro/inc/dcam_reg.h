...
#define DCAM_GTM_STATUS0                                (DCAM_COMMON_BASE + 0x0094UL)
#define DCAM_GTM_STATUS1                                (DCAM_COMMON_BASE + 0x0098UL)
#define DCAM_GTM_STATUS2                                (DCAM_COMMON_BASE + 0x009CUL)
#define DCAM_GTM_STATUS3                                (DCAM_COMMON_BASE + 0x00A0UL)
#define DCAM_GTM_STATUS4                                (DCAM_COMMON_BASE + 0x00A4UL)
#define DCAM_GTM_STATUS5                                (DCAM_COMMON_BASE + 0x00A8UL)
#define DCAM_PRE_FBC_STATUS0                            (DCAM_COMMON_BASE + 0x00ACUL)
#define DCAM_PRE_FBC_STATUS1                            (DCAM_COMMON_BASE + 0x00B0UL)
#define DCAM_PRE_FBC_STATUS2                            (DCAM_COMMON_BASE + 0x00B4UL)
#define DCAM_PRE_FBC_STATUS3                            (DCAM_COMMON_BASE + 0x00B8UL)
#define DCAM_CAP_FBC_STATUS0                            (DCAM_COMMON_BASE + 0x00BCUL)
#define DCAM_CAP_FBC_STATUS1                            (DCAM_COMMON_BASE + 0x00C0UL)
#define DCAM_CAP_FBC_STATUS2                            (DCAM_COMMON_BASE + 0x00C4UL)
#define	DCAM_CAP_FBC_STATUS3                            (DCAM_COMMON_BASE + 0x00C8UL)
...
#define GTM_TM_LUMAFILTER0                              (DCAM_GTM_BASE + 0x0044UL)
#define GTM_TM_LUMAFILTER1                              (DCAM_GTM_BASE + 0x0048UL)
#define GTM_TM_LUMAFILTER2                              (DCAM_GTM_BASE + 0x004CUL)
