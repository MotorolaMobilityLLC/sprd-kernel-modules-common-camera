...
struct ip_dvfs_map_cfg depth_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_DEPTH_INDEX0_MAP, VOLT60, DEPTH_CLK1280,
		DEPTH_CLK_INDEX_1280, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_DEPTH_INDEX1_MAP, VOLT60, DEPTH_CLK1920,
		DEPTH_CLK_INDEX_1920, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_DEPTH_INDEX2_MAP, VOLT60, DEPTH_CLK2560,
		DEPTH_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg dcam0_1_axi_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_DCAM0_1_AXI_INDEX0_MAP, VOLT60,
		DCAM0_1_AXI_CLK1536, DCAM0_1_AXI_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_DCAM0_1_AXI_INDEX1_MAP, VOLT60,
		DCAM0_1_AXI_CLK2560, DCAM0_1_AXI_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_DCAM0_1_AXI_INDEX2_MAP, VOLT60,
		DCAM0_1_AXI_CLK3072, DCAM0_1_AXI_CLK_INDEX_3072, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg dcam2_3_axi_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_DCAM2_3_AXI_INDEX0_MAP, VOLT60,
		DCAM2_3_AXI_CLK960, DCAM2_3_AXI_CLK_INDEX_960, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_DCAM2_3_AXI_INDEX1_MAP, VOLT60,
		DCAM2_3_AXI_CLK1280, DCAM2_3_AXI_CLK_INDEX_1280, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_DCAM2_3_AXI_INDEX2_MAP, VOLT60,
		DCAM2_3_AXI_CLK1536, DCAM2_3_AXI_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg dcam_mtx_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_DCAM_MTX_INDEX0_MAP, VOLT60,
		DCAM_MTX_CLK1536, DCAM_MTX_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_DCAM_MTX_INDEX1_MAP, VOLT60,
		DCAM_MTX_CLK3072, DCAM_MTX_CLK_INDEX_3072, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg fd_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_FD_INDEX0_MAP, VOLT60,
		FD_CLK1280, FD_CLK_INDEX_1280, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_FD_INDEX1_MAP, VOLT60,
		FD_CLK1920, FD_CLK_INDEX_1920, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_FD_INDEX2_MAP, VOLT60,
		FD_CLK2560, FD_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg isp_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_ISP_INDEX0_MAP, VOLT60,
		ISP_CLK1536, ISP_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_ISP_INDEX1_MAP, VOLT60,
		ISP_CLK2560, ISP_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_ISP_INDEX2_MAP, VOLT60,
		ISP_CLK3072, ISP_CLK_INDEX_3072, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg jpg_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_JPG_INDEX0_MAP, VOLT60,
		JPG_CLK1536, JPG_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_JPG_INDEX1_MAP, VOLT60,
		JPG_CLK2560, JPG_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_JPG_INDEX2_MAP, VOLT60,
		JPG_CLK3072, JPG_CLK_INDEX_3072, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg mtx_data_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_MM_MTX_DATA_INDEX0_MAP, VOLT60,
		MM_MTX_DATA_CLK3072, MM_MTX_DATA_CLK_INDEX_3072, 0, 0, 0, 0, "0.6v"},
...
struct ip_dvfs_map_cfg vdsp_dvfs_config_table[8] = {
	...
	{3, REG_MM_DVFS_AHB_VDSP_INDEX3_MAP, VOLT65,
		...
		0, 0, "0.65v"},
	{4, REG_MM_DVFS_AHB_VDSP_INDEX4_MAP, VOLT65,
...
struct ip_dvfs_map_cfg vdma_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_VDMA_INDEX0_MAP, VOLT60,
		VDMA_CLK260, VDMA_CLK_INDEX_260, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_VDMA_INDEX1_MAP, VOLT60,
		VDMA_CLK1536, VDMA_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{2, REG_MM_DVFS_AHB_VDMA_INDEX2_MAP, VOLT60,
		VDMA_CLK2560, VDMA_CLK_INDEX_2560, 0, 0, 0, 0, "0.6v"},
	{3, REG_MM_DVFS_AHB_VDMA_INDEX3_MAP, VOLT65,
		VDMA_CLK3072, VDMA_CLK_INDEX_3072, 0, 0, 0, 0, "0.65v"},
	{4, REG_MM_DVFS_AHB_VDMA_INDEX4_MAP, VOLT65,
...
struct ip_dvfs_map_cfg vdsp_mtx_dvfs_config_table[8] = {
	{0, REG_MM_DVFS_AHB_VDSP_MTX_INDEX0_MAP, VOLT60,
		VDSP_MTX_CLK1536, VDSP_MTX_CLK_INDEX_1536, 0, 0, 0, 0, "0.6v"},
	{1, REG_MM_DVFS_AHB_VDSP_MTX_INDEX1_MAP, VOLT65,/*60->65*/
