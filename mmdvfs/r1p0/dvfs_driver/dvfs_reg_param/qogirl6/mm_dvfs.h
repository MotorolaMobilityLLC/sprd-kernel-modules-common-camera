...
enum {
	DCAM_CLK_INDEX_480 = 0, //48
	DCAM_CLK_INDEX_1920 = 1, //192
	DCAM_CLK_INDEX_640 = 2, //64
	DCAM_CLK_INDEX_2560 = 3, //256
	DCAM_CLK_INDEX_768 = 4, //76.8
	DCAM_CLK_INDEX_3072 = 5, //307.2
	DCAM_CLK_INDEX_3840 = 6, //384
	DCAM_CLK_INDEX_4680 = 7, //468
};
