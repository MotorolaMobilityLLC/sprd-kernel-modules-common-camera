...
static struct dcam_hw_abt dcamhw_ability = {
	...
	.fmcu_support = ENABLE,
	.pyramid_support = ENABLE,
	.bpc_raw_support = ENABLE,
	...
	.vch3_output_pdaf_support = ENABLE,
...
static struct isp_hw_abt isphw_ability = {
	...
	.fetch_raw_support = DISABLE,
	.pyr_rec_support = ENABLE,
	.pyr_dec_support = ENABLE,
	.rgb_ltm_support = ENABLE,
	.rgb_gtm_support = DISABLE,
	.frbg_hist_support = ENABLE,
	.nr3_compress_support = DISABLE,
	.static_map_support = ENABLE,
#if defined (PROJ_QOGIRN6L)
	.pyr_rec_lay0_support = ENABLE,
#elif defined (PROJ_QOGIRN6PRO)
	.pyr_rec_lay0_support = DISABLE,
#endif
