...
static int load_vst_ivst_buf(struct dcam_isp_k_block *p)
{
	int ret = 0;
	uint32_t buf_len;
	uint32_t val;
...
int dcam_k_nlm_block(struct dcam_isp_k_block *p)
{
	int ret = 0;
...
int dcam_k_nlm_imblance(struct dcam_isp_k_block *p)
{
	int ret = 0, idx = 0;
...
int dcam_k_save_vst_ivst(struct dcam_isp_k_block *p)
{
	int ret = 0;
	uint32_t buf_len = 0;
