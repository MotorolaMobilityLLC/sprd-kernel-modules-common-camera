...
static struct dcam_hw_abt dcamhw_ability = {
	...
	.bpc_raw_support = DISABLE,
	.superzoom_support = ENABLE,
	.lbuf_share_support = DISABLE,
	.recovery_support = DCAMINT_FATAL_ERROR,
	.dummy_slave_support = DCAM_DUMMY_SW_CLOSE,
	.offline_slice_support = DISABLE,
	.dcam_offline_fbc_support = DISABLE,
	.vch3_output_pdaf_support = DISABLE,
	.mul_raw_output_support = DISABLE,
	...
	.dcam_block[12] = DCAM_BLOCK_GRGB,
	.dcam_block[13] = DCAM_BLOCK_BAYERHIST,
};

static struct dcamlite_hw_abt dcamlitehw_ability = {
	.sensor_raw_fmt = CAM_RAW_PACK_10,
	.raw_fmt_support[0] = CAM_RAW_HALFWORD_10,
	.raw_fmt_support[1] = CAM_RAW_PACK_10,
...
static struct isp_hw_abt isphw_ability = {
	.slm_cfg_support = DISABLE,
	.ctx_fmcu_support = isp_ctx_fmcu_support,
	.fetch_raw_support = ENABLE,
	.pyr_rec_support = DISABLE,
	.pyr_dec_support = DISABLE,
	.rgb_ltm_support = DISABLE,
	.rgb_gtm_support = DISABLE,
	.frbg_hist_support = DISABLE,
	.nr3_compress_support = DISABLE,
	.static_map_support = DISABLE,
	...
	.isp_block[1] = ISP_BLOCK_CFA,
	.isp_block[2] = ISP_BLOCK_CMC,
	.isp_block[3] = ISP_BLOCK_GAMMA,
	.isp_block[4] = ISP_BLOCK_HSV,
	.isp_block[5] = ISP_BLOCK_PSTRZ,
	.isp_block[6] = ISP_BLOCK_CCE,
	.isp_block[7] = ISP_BLOCK_PRE_CDN,
	.isp_block[8] = ISP_BLOCK_CDN,
	.isp_block[9] = ISP_BLOCK_POST_CDN,
	.isp_block[10] = ISP_BLOCK_UVD,
	.isp_block[11] = ISP_BLOCK_YNR,
	.isp_block[12] = ISP_BLOCK_BRIGHTNESS,
	.isp_block[13] = ISP_BLOCK_CONTRAST,
	.isp_block[14] = ISP_BLOCK_HIST,
	.isp_block[15] = ISP_BLOCK_EDGE,
	.isp_block[16] = ISP_BLOCK_YGAMMA,
	.isp_block[17] = ISP_BLOCK_HUE,
	.isp_block[18] = ISP_BLOCK_IIRCNR,
	.isp_block[19] = ISP_BLOCK_YRANDOM,
	.isp_block[20] = ISP_BLOCK_CSA,
};
