...
enum cam_node_cfg_cmd {
	...
	CAM_NODE_CFG_ICAP_SCENE_SWITCH,
	CAM_NODE_CFG_ICAP_RAW_REPORT_CONDITION,
	CAM_NODE_CFG_GET_CAP_FRAME,
	CAM_NODE_CFG_PRE_FRAME_STATUS,
	CAM_NODE_CFG_FLASH_SKIP_FID,
